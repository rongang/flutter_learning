    ...
    public void onMethodCall(MethodCall call, Result result) {
        switch (call.method) {
            ...
            case "scan_path":
                ...
                CodeUtils.AnalyzeCallback analyzeCallback = (CodeUtils.AnalyzeCallback) new CustomAnalyzeCallback(this.result, this.activity.getIntent());
            ...
            case "scan_bytes":
                ...
                CodeUtils.analyzeBitmap(bitmap, (CodeUtils.AnalyzeCallback) new CustomAnalyzeCallback(this.result, this.activity.getIntent()));
                break;
        ...
        if (code == REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK && intent != null) {
                ...
                if (secondBundle != null) {
                    try {
                        CodeUtils.AnalyzeCallback analyzeCallback = (CodeUtils.AnalyzeCallback) new CustomAnalyzeCallback(this.result, intent);
