...
const prefixDefault = '''[
  ...
  { "prefix": "244", "en": "Angola", "cn": "安哥拉" },
  { "prefix": "1264", "en": "Anguilla", "cn": "安圭拉" },
  { "prefix": "247", "en": "Asc"en"sion", "cn": "阿森松岛" },
  { "prefix": "1268", "en": "Antigua and Barbuda", "cn": "安提瓜和巴布达" },
  { "prefix": "54", "en": "Argentina", "cn": "阿根廷" },
  { "prefix": "374", "en": "Armenia", "cn": "亚美尼亚" },
  { "prefix": "297", "en": "Aruba", "cn": "阿鲁巴" },
...
void main(List args){
//  var result = jsonDecode("prefix"Sorted);
  final PhoneNumberAreaList = [];
  JsonUtil.getObjectList(prefixSorted, (v){
//    print('$v');
    PhoneNumberAreaList.add(PhoneNumberArea.formJson(v));
  });
  print('$PhoneNumberAreaList');
//  print("$result");
//  var list = List.g"en"erate(100, (index) => Phon"en"umberArea.formJson(pre));
...
class PhoneNumberArea{
  ...
  PhoneNumberArea.formJson(Map<String,dynamic> json){
    prefix = json['prefix'];
    nameEn = json['en'];
    nameCn = json['cn'];
  }
  ...
  @override
  String toString() {
    return 'PhoneNumberArea{prefix: $prefix, nameEn: $nameEn, nameCn: $nameCn}';
  }
}