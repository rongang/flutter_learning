...
class DeviceResource extends StatefulWidget {
  @override
  _DeviceResourceState createState() => _DeviceResourceState();
}

class _DeviceResourceState extends State<DeviceResource> {
  @override
  void initState() {
    super.initState();
  }
