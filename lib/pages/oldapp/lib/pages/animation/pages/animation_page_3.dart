...
class _AnimationPage3State extends State<AnimationPage3> with SingleTickerProviderStateMixin {
...
class MyCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var controlPoint2 = Offset((3 * size.width / 4) - 70, (size.height / 3) + 160);
    ...
    canvas.drawCircle(size.center(Offset.zero), 80, Paint()..color = Colors.white);
    canvas.drawCircle(size.center(Offset(-30, -20)), 10, Paint());
    canvas.drawCircle(size.center(Offset(30, -20)), 10, Paint());

    canvas.drawOval(Rect.fromCenter(center: size.center(Offset(0, 220)), width: 300, height: 400), Paint()..color = Colors.white);
