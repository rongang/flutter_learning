...
const drugDetails = [
  {
    ...
    'name':'阿司匹林片（修正药业）',
    'standard':'0.3g',
    'factory':'修正药业集团股份有限公司'
  },{
    'name':'伯基（阿司匹林肠溶胶囊）',
    'standard':'0.1g',
    'factory':'永信药品工业（昆山）股份有限公司'
  },
];
...
//  }
  ...
  Widget buildLeading(BuildContext context) {
    return IconButton(onPressed: (){Navigator.pop(context);}, icon: Icon(Icons.arrow_back_ios,size: 20,));
  }
