...
const String IMAGE = 'http://img.netbian.com/file/2020/0510/479b031678647c8e69e2a27dbc1d251c.jpg';

class animation_1 extends StatefulWidget {
  final Widget child;

  const animation_1({Key? key, required this.child}) : super(key: key);
...
class _animation_1State extends State<animation_1> with TickerProviderStateMixin {
    ...
    return Center(
      child: AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget? child) {
          return Center(
            child: Container(height: MediaQuery.of(context).size.height, width: animation.value, child: child),
          );
        },
        child: child,
      ),
